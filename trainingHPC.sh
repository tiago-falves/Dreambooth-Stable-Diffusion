...
python scripts/stable_txt2img.py   --ddim_eta 0.0    --n_iter 4   --scale 7.0   --ddim_steps 50   --ckpt "./trained_models/2022-10-19T16-57-15_HSIL_203_training_images_10000_max_training_steps_firstNameLastName_token_cell_class_word.ckpt"   --prompt "carcinoma cell"
