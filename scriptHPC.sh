...
python "main.py"   --base configs/stable-diffusion/v1-finetune_unfrozen.yaml   -t   --actual_resume "model.ckpt"   --reg_data_root "./regularization_images/cell"   -n "carcinoma"   --gpus 0,   --data_root "./training_images/really_carcinoma"   --max_training_steps 10000   --class_word "cell"   --token "carcinoma"   --no-test
